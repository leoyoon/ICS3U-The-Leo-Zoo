...
/**
 * @TODO 	fix the adding animals part
 * 			work on giving names
 * 			saveFile
 * 					
 *
 */
...
public class Zoo extends JFrame implements ActionListener
{
	 ...
	 */
	private int animalRandomNumber, rescueTries, saveFile, animalSpawned, goodTiles;
	...
	ArrayList<Pig> pig = new ArrayList<Pig>();
	ArrayList<Cow> cow = new ArrayList<Cow>();
	ArrayList<Horse> horse = new ArrayList<Horse>();
	ArrayList<Unicorn> unicorn = new ArrayList<Unicorn>();
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		for (int i = 0; i < files.length; i++)
		{
			if (e.getSource() == files[i])
			{
				...
				for (int j = 0; j < Sheep.getNumSheep(); j++)
				{
					animalDisplay[j].setEnabled(true);
				}
		...
		for (int i = 0; i < 6; i++)
		{
			if (e.getSource() == animalPens[i])
			{
				...
				case 1:					
					...
					{
						animalNames[a].setText(sheep.get(a).getName());
				...
				case 2:										
					...
					{
						animalNames[b].setText(rabbit.get(b).getName());
				...
				case 3:
					...
					{
						animalNames[c].setText(pig.get(c).getName());
				...
				case 4:
					...
					{
						animalNames[d].setText(cow.get(d).getName());
				...
				case 5:
					...
					{
						animalNames[f].setText(horse.get(f).getName());
				...
				case 6:
					...
					{
						animalNames[g].setText(unicorn.get(g).getName());
...
ArrayList rabbit: <Rabbit>
ArrayList pig: <Pig>
ArrayList cow: <Cow>
ArrayList horse: <Horse>
ArrayList unicorn: <Unicorn>
